...
<!-- Navigation Bar -->
<nav class="nav-bar">
  <a href="#" class="nav-brand">MCCSys@ICS26</a>
  <div class="nav-links">
    <a href="#about">About</a>
    <a href="#call-for-presentations">Call for Papers</a>
...
<div class="hero-section">
  ...
  <div class="hero-buttons">
    <a href="https://forms.gle/8gpCi3JKdyKtYEbn7" class="btn btn-primary" target="_blank">Submit Abstract</a>
    <a href="https://dipsa-qub.github.io/ICS2026-webpage/" class="btn btn-secondary" target="_blank">Register Now</a>
  </div>
</div>
...
<div class="dates-sidebar">
  <div class="date-item">
    ...
    <div class="date-value">April 20th, 2026</div>
  </div>
  <div class="date-item">
    <div class="date-label">Notification Date</div>
    <div class="date-value">April 25th, 2026</div>
  </div>
  <div class="date-item">
    <div class="date-label">Workshop Date</div>
    <div class="date-value">July 6th, 2026</div>
  </div>
</div>
...
**Please submit your extended abstract by filling out [this form](https://forms.gle/6xwQYU4Ehs3Hrk7A9)**.
...
<div class="key-dates-section">
  <div class="key-date-row">
    ...
    <span class="key-date-value">April 20, 2026 (23:59 AoE)</span>
  </div>
  <div class="key-date-row">
    <span class="key-date-label">Notification of Acceptance</span>
    <span class="key-date-value">April 25, 2026</span>
  </div>
  <div class="key-date-row">
    <span class="key-date-label">Workshop Date</span>
    <span class="key-date-value">July 6, 2026 (Full Day)</span>
  </div>
</div>
...
### Accepted Papers {#speakers}

<div class="speakers-placeholder">
  <p><strong>Accepted Papers To Be Announced</strong></p>
</div>
...
<div class="organizer-item">
  ...
  <div class="organizer-info">
    ...
    <p class="organizer-bio">Ismail Emir Yuksel is a 3rd-year PhD student in the SAFARI Research Group at ETH Zurich under the supervision of Prof. Onur Mutlu. His current broader research interests are in computer architecture, processing-in-memory, and hardware security, focusing on understanding, enhancing, and exploiting fundamental computational capabilities of modern DRAM architectures. His recent publications show that commodity DRAM chips, without any modification to the chip itself (only with modifications to the memory controller), are able to execute bulk-bitwise computation and data movement operations (including NAND, NOR, NOT, AND, OR, MAJority, multi-row copy, and initialization functions) in a reasonably robust manner.</p>
...
<div class="past-editions-grid">
  <div class="past-edition-item">
    <a href="https://events.safari.ethz.ch/asplos26-MCCSys/" target="_blank">5th Workshop on Memory-Centric Computing Systems (MCCSys)</a>
    <div class="past-edition-year">ASPLOS 2026</div>
  </div>
  <div class="past-edition-item">
